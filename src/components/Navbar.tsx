  ...
  return (
    ...
    >
      ...
      <div className="flex h-14 md:h-20 items-center justify-between px-4 md:px-6">
            ...
            {navLinks.map((link) => {
              ...
              return (
                <Link
                  key={link.to}
                  to={link.to}
                  className={`px-3 py-1.5 rounded-lg text-[10px] md:text-xs font-bold uppercase tracking-widest transition-all duration-200 ${
                    isActive
        ...
        {showHUD ? (
          /* Desktop HUD — hidden on mobile, shown md+ */
