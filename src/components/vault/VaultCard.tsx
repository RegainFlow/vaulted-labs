          ...
          <div className="p-4 sm:p-5 md:p-6 bg-gradient-to-b from-white/5 to-transparent flex-1 flex flex-col">
                        ...
                        <span className="text-white">
                          ...
                          {prestigeLevel > 0 && delta !== 0 && (
                            <span
                              ...
                              style={{ color: PRESTIGE_COLORS[prestigeLevel] }}
                            >
                              {delta > 0 ? "+" : ""}
                              {delta}%
                            </span>
                      ...
                      <div className="text-right">
                        <span className="text-[13px] font-mono text-text-dim">
                          ...
                          {Math.max(
                            1,
                            Math.round(
                              vault.price * cfg.minMult - VALUE_RANGE_REDUCTION
                            )
                          )}{" "}
                          - $
                          {Math.round(
            ...
            <div className="mt-8 text-center">
              <span
                ...
                style={{
                  color: !canAfford ? "var(--color-error)" : vault.color,
                }}
              >
                {!canAfford ? "Insufficient Credits" : "Open Vault"}
              </span>
            </div>
          </div>
