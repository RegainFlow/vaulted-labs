      ...
      <div className="relative mx-auto grid w-full max-w-6xl items-center gap-10 lg:grid-cols-[1fr_360px]">
        <div>
          ...
          <p className="mt-5 max-w-2xl text-lg text-text-muted">
            Experience the thrill of the unlock anywhere. Our mobile-first interface ensures seamless access to your portfolio and instant liquidity mechanisms.
          </p>
...
function MiniAppPreview() {
    const [screen, setScreen] = useState<"home" | "vault" | "grid" | "reveal" | "result">("home");
    ...
    return (
        <div className="flex flex-col h-full bg-[#050505] text-white font-sans overflow-hidden relative">
            ...
            <div className="h-14 flex items-center justify-between px-4 border-b border-white/5 z-20 bg-bg/95 backdrop-blur-md">
                <div className="font-black italic text-sm tracking-tighter">VAULTED</div>
        ...
        >
            <div className="h-32 w-full shrink-0 rounded-2xl bg-gradient-to-br from-accent/20 to-purple-900/20 border border-accent/30 flex items-center justify-center relative overflow-hidden">
                ...
                <div className="text-center z-10">
                    <div className="text-[10px] text-accent font-bold uppercase tracking-widest mb-1">New Arrival</div>
                    <div className="text-2xl font-black italic tracking-tighter">PRISMA CASE</div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
                {[
                    ...
                    <div key={tier.name} className="h-32 rounded-xl bg-surface-elevated border border-white/5 p-3 flex flex-col justify-end relative overflow-hidden group">
                        ...
                        <div className="relative z-10">
                            <div className="text-[10px] font-bold text-white uppercase">{tier.name}</div>
                            <div className="text-[8px] text-text-dim font-mono">{tier.price}</div>
                        </div>
                        {tier.name === 'Diamond' && (
                             <motion.div 
...
function GridScreen() {
    return (
        ...
        >
            <div className="text-[10px] font-black uppercase tracking-[0.3em] mb-8 text-white/30">Select Containment Unit</div>
            <div className="grid grid-cols-3 gap-3 w-full max-w-[240px]">
                {Array.from({ length: 9 }).map((_, i) => (
                    ...
                    >
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className={i === 4 ? "text-[#b9f2ff]" : "text-white/10"}>
...
function RevealScreen() {
    return (
        ...
        >
            ...
            <div className="text-[10px] font-mono text-[#b9f2ff] tracking-[0.4em] animate-pulse">DECOMPRESSING...</div>
        </motion.div>
    )
}
    ...
    return (
        ...
        >
            ...
            <div className="w-32 h-32 rounded-2xl bg-[#0a0a0f] border-2 border-[#b9f2ff] shadow-[0_0_30px_rgba(185,242,255,0.2)] flex items-center justify-center mb-6 relative z-10">
                ...
                <div className="absolute -bottom-2 px-3 py-1 bg-neon-green/20 rounded-full border border-neon-green/50 text-[6px] font-black uppercase tracking-widest text-neon-green">Mint Condition</div>
            </div>
            
            <h3 className="text-2xl font-black italic text-white mb-1 relative z-10 tracking-tighter">LEGENDARY PULL</h3>
            <p className="text-[#b9f2ff] font-bold text-sm mb-8 relative z-10">$1,200.00</p>
            
            <div className="flex flex-col gap-2 w-full max-w-[200px] relative z-10">
                <div className="flex gap-2">
                    <div className="flex-1 py-2.5 rounded-lg bg-surface-elevated border border-white/10 text-[8px] font-bold uppercase text-white/50">Ship</div>
                    <div className="flex-1 py-2.5 rounded-lg bg-surface-elevated border border-white/10 text-[8px] font-bold uppercase text-white/50">Hold</div>
                </div>
