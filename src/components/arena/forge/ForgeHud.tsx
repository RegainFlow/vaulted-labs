...
export function ForgeHud({
  ...
  return (
    <div className="system-rail relative overflow-hidden rounded-[24px] px-4 py-3.5">
      ...
      <div className="relative z-10 flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
        ...
        <div className="grid gap-2 sm:grid-cols-3 xl:min-w-[28rem]">
          <div className="system-readout rounded-[16px] px-3 py-2.5">
          ...
          <div className="system-readout rounded-[16px] px-3 py-2.5">
            ...
            <div className="mt-1.5 text-base font-black uppercase tracking-[0.08em] text-vault-gold">
              {freeSpins}
            </div>
          </div>
          <div className="system-readout rounded-[16px] px-3 py-2.5">
            ...
            <div className="mt-1.5 text-sm font-black uppercase tracking-[0.08em] text-accent sm:text-base">
