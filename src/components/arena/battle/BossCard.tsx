...
export function BossDisplay({
  ...
  return (
    <motion.div
      ...
      className="relative mx-auto w-full max-w-[156px] sm:max-w-[260px]"
    >
      <div
        ...
        <div className="relative z-10">
          <div className="flex items-start justify-between gap-2">
            <div className="min-w-0">
              ...
              <div className="mt-1 text-sm font-black uppercase tracking-[0.06em] text-white sm:text-lg">
                {battle.name}
              </div>
            </div>
            <span className="rounded-full border border-accent/25 bg-accent/10 px-2 py-1 text-[7px] font-black uppercase tracking-[0.2em] text-accent sm:px-2.5 sm:text-[8px]">
              {statusLabel}
            </span>
          </div>

          <div className="relative mx-auto mt-2.5 flex h-[108px] items-center justify-center rounded-[20px] border border-white/10 bg-black/28 sm:mt-4 sm:h-[200px] sm:rounded-[28px]">
            <div
            ...
            <div className="relative z-10 flex h-14 w-14 items-center justify-center rounded-full border border-white/10 bg-black/42 shadow-[0_0_36px_rgba(255,43,214,0.18)] sm:h-28 sm:w-28">
              <BossIcon bossId={battle.id} size={46} color={profile.accentPrimary} />
            </div>
          </div>
        </div>
      </div>
