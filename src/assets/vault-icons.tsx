export const bronzeIcon = (color: string) => (
  ...
  >
    <path
      d="M12 4.5c-2 0-3.5 1.5-4 3-.5 1.5-2 2-2.5 3.5-.5 1.5.5 3.5 2 4.5 1.5 1 3.5 1 5 .5 1.5-.5 2.5-1.5 4-2 1.5-.5 2.5-2.5 2-4-.5-1.5-2-2.5-3.5-3.5-1.5-1-2.5-2-3-2z"
...
export const goldIcon = (color: string) => (
  ...
  >
    ...
    <path
      d="M12 3l3 6 6 2-5 5 1 7-7-3-7 3 1-7-5-5 6-2 3-6z"
      strokeLinejoin="round"
    />
