...
export const AnalyticsEvents = {
  ...
  PROVABLY_FAIR_DOC_OPENED: "provably_fair_doc_opened",
  PROVABLY_FAIR_RECEIPT_OPENED: "provably_fair_receipt_opened",
  PROVABLY_FAIR_RECEIPT_VERIFIED: "provably_fair_receipt_verified",
  PROVABLY_FAIR_SEED_ROTATED: "provably_fair_seed_rotated",
